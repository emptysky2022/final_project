...
public class CampRestController {
	...
	public ResponseEntity<List<Object>> getListByReview(@PathVariable("cno") Long cno ,@AuthenticationPrincipal PrincipalDetails principalDetails){
	...
	public ResponseEntity<List<Object>> getListByCamp(@PathVariable("type") String[] type, @PathVariable("locations") String[] locations, @AuthenticationPrincipal PrincipalDetails principalDetails){
	...
	@PutMapping("/modify")
	public ResponseEntity<Object> getData(@RequestBody CampDTO dto,  @AuthenticationPrincipal PrincipalDetails principalDetails){
